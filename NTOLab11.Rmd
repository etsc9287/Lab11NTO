...
* Findings: The appears to be great significance between the change in proportion of "Ariel" names and the change in proportion of all names that start wuth a vowel, as Ariel is the 99.8th percentile at a difference of 0.00128231, only behind "Alyssa".  This graph displays these propotion difference for the most increasingly popula female names from 1988 to 1990. 
